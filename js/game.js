...
function beginBasketBall()
{
    ...
    ball.addEventListener('touchstart', function(ev){ev.preventDefault; ev.dataTransfer.setData('text/plain', 'ball'); ev.dataTransfer.effectAllowed = 'move'; startPos = [ev.x, ev.y];});
