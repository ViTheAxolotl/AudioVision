...
function beginBasketBall()
{
    ...
    for(let i = 0; i < label.length; i++)
    {
        ...
        if(i == 0){elm.onmouseup = handleSweetSpot; elm.style.display = "block"; ss = elm; elm.onload = () => {elm.style.marginLeft = `${(hoop.offsetWidth - ss.offsetWidth) / 2}`; alert(elm.style.marginLeft);};}
